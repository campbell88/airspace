...
import { withScriptjs, withGoogleMap, GoogleMap, Marker,Polygon  } from 'google-maps-react';
...
const MyMapComponent = compose(
  withProps({
      googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyD3uXZRFB9AlWQe-ZoMa4tDzgU_l_XUB_0",
  ...
  <GoogleMap defaultZoom={9} defaultCenter={{ lat: 41.015137, lng: 28.979530 }}>
      {props.isMarkerShown && <Marker position={{ lat: 41.015137, lng: 28.979530 }} />}
      <Polygon
          path={reversedCoords}
          key={'AIzaSyD3uXZRFB9AlWQe-ZoMa4tDzgU_l_XUB_0'}
          options={{
              fillColor: "#000",
              fillOpacity: 0.4,
              strokeColor: "#000",
